      ...
      <main className={classes["LandingContainer"]}>
        <div className={classes["LandingContainer__content"]}>
          <Container>
            <div className={classes["LandingContainer__content-text"]}>
              ...
              <p>
                Ven a nuestros espacios, sal de tu rutina de siempre. Ponte
                cómodo en nuestras salas y disfruta de un buen snack para
                alegrarte el día.
              </p>
              <Link to="/about-us">
            ...
            <div className={classes["LandingContainer__content-image"]}></div>
          </Container>
        </div>
        ...
        <Container>
          ...
          <MenuContainer>
            ...
            <p>
              Sabemos que te encanta disfrutar de un buen snack mientras
              ejercitas tu mente o necesitar pensar. Es por eso que hemos creado
              una selección de comida especialmente para ti.
            </p>
            <p>
              {" "}
              Explora nuestra variedad de platillos que puedes ingresar a las
              salas de trabajo a un buen precio.
            </p>
          </MenuContainer>
